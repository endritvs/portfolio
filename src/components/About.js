    ...
    <div className="center-100 home">
        ...
        <div className="flex-container">
          ...
          <div className="center-100">
            <p className="text text-white  description-work">
              <span className="yellowMe"> WEB DEVELOPER (EUROPIXEL)</span> - In
              EUROPIXEL I had the role of an intern where I also participated in
              their real projects of the company, my role was mostly in the part
              of FRONT-END DEVELOPER where I showed myself on sites like: GERMAN
              EYE CLINIC, HEROINATES, NOBELPRESS and many other sites
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex-containerPro">
          <div className="center-100">
            <p className="text text-white  description-work">
              ...
              JavaScript, jQuery) 2. Web Development Basics(PHP & MySQL) 3. Web
              Development with real project 4. Bootstrap 5 5. Git, 6. OOP PHP
              and MySQL 7. WordPress Administration 8. Laravel
            </p>
          </div>
        ...
        <div className="flex-container">
          ...
          <div className="center-100">
            <p className="text text-white  description-work">
              ...
              MongoDB, NodeJS) Learn how to implement JWT for authentication and
              authorization Learn how to implement React Hooks, Async/Await,
              React Router 6, Axios Learn how to implement ES6 in Node Learn
      ...
      <div className="center-100 mt">
        <h1
          ...
          className="center text text-center text-white mb typing-size"
        >
          {"<"}Technologies I have <span className="yellowMe">EXPERIENCE!</span>
          {"/>"}
        </h1>
      </div>
